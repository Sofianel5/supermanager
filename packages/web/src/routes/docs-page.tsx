...
const CREATE_PROJECT_COMMAND = "supermanager create project";
const JOIN_PROJECT_COMMAND = 'supermanager join "<project-id>"';
const CODEX_MCP_QUESTION_COMMAND =
  'codex "List the projects I can access in Supermanager and summarize what changed today."';
const CLAUDE_MCP_QUESTION_COMMAND =
  'claude "List the projects I can access in Supermanager and summarize what changed today."';
      ...
      <section className="grid gap-0">
        <article className="grid gap-4 border-b border-border py-8">
          ...
          <p className={heroCopyClass}>
            ...
            connecting to a project - a shared destination where your team&apos;s
          ...
          <li className="grid gap-4 border-b border-border py-8 md:grid-cols-[84px_minmax(0,1fr)] md:gap-6">
            ...
            <div className="grid gap-5">
              <div className="grid gap-3">
                ...
                <p className={bodyCopyClass}>
                  A project is a shared destination for Claude Code and Codex
                  activity. This is the step that starts sending activity from
                  the repo to Supermanager. Most teams use one project per repo. If
                  that doesn’t fit how you work, you can also use one project for a
                  whole team or project.
                </p>
                <p className={bodyCopyClass}>
                  Connecting to a project installs Claude/Codex hooks within your
                  project that send activity to Supermanager. From inside the
                  repo you want to track, either create a new project or join one a
              ...
              <div className="grid gap-6 md:grid-cols-2 md:gap-8">
                <div className="grid gap-3">
                  ...
                  <p className="m-0 max-w-[32rem] text-base leading-7 text-ink-dim">
                    You'll get a link to the project dashboard where you can send
                    join instructions to teammates.
                  </p>
                  <div className="max-w-[36rem]">
                    <CommandBlock
                      copyKey="create-project"
                ...
                <div className="grid gap-3 md:border-l md:border-border md:pl-8">
                  ...
                  <p className="m-0 max-w-[32rem] text-base leading-7 text-ink-dim">
                    Use this if a teammate has already created a project for your
                    repo. Ask them for the join command or project ID.
                  </p>
                  <div className="max-w-[36rem]">
                    <CommandBlock
                      copyKey="join-project"
                      label="Join project"
        ...
        <article className="grid gap-5 py-8" id="mcp-setup">
          ...
          <p className={heroCopyClass}>
            ...
            questions that need evidence, history, or cross-project context.
          </p>
          <p className={bodyCopyClass}>
            ...
            read-only access to the projects, summaries, and historical events you
          ...
          <div className="grid gap-8 border-t border-border pt-6">
            <div className="grid gap-4">
              ...
              <ul className="grid list-disc gap-3 pl-6 text-base leading-7 text-ink-dim marker:text-ink-dim">
                <li>
                  <code className={inlineCodeClass}>list_projects</code> to see the
                  projects you can access in your organization.
                </li>
                <li>
                ...
                <li>
                  <code className={inlineCodeClass}>get_project_summary</code> to
                  read the current summary for one project.
                </li>
                <li>
                  <code className={inlineCodeClass}>get_project_feed</code> to
                  inspect raw activity from a single project.
                </li>
                <li>
                  <code className={inlineCodeClass}>query_events</code> to
                  filter historical events by project, person, repo, branch,
                  client, or timeframe.
                </li>
                <li>
            ...
            <div className="grid gap-4 border-t border-border pt-6">
              ...
              <ul className="grid list-disc gap-3 pl-6 text-base leading-7 text-ink-dim marker:text-ink-dim">
                <li>What changed across the Frontend and API projects today?</li>
                <li>
                ...
                <li>What happened in the Design System project before this PR?</li>
              </ul>
            </div>
          </div>
        </article>
