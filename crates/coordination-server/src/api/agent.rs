...
impl SummaryTool {
    ...
    fn parse(params: &DynamicToolCallParams) -> Result<Self> {
...
fn format_event(event: &StoredHookEvent) -> Result<String> {
...
fn tool_success(message: impl Into<String>) -> DynamicToolCallResponse {
...
fn tool_failure(message: impl Into<String>) -> DynamicToolCallResponse {
    DynamicToolCallResponse {
        content_items: vec![DynamicToolCallOutputContentItem::InputText {
            text: message.into(),
        }],
