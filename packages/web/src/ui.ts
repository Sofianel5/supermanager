...
export const surfaceClass =
  "border border-border bg-[linear-gradient(180deg,rgba(17,24,37,0.72),rgba(8,12,19,0.88))] backdrop-blur-xl";
...
export const inputClass =
  "w-full border border-border bg-panel px-4 py-3 text-base text-ink outline-none transition focus:border-accent";

export const jumboInputClass =
  "w-full border border-border bg-panel px-6 py-5 text-2xl text-ink outline-none transition focus:border-accent sm:text-[1.75rem]";

const actionBaseClass =
  "inline-flex min-h-[46px] items-center justify-center gap-2 border px-[18px] text-center transition duration-150 hover:-translate-y-px disabled:cursor-wait disabled:opacity-70";
...
export const copySheetClass =
  "w-full border border-border bg-panel p-4 text-left transition duration-150 hover:-translate-y-px";
